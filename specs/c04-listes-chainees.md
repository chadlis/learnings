...
- **Figure 2 — `SL.trace`** : liste de 6 nœuds, `ptr` = {lent, rapide}, 4 images jusqu'à l'arrêt de rapide ; puis même liste avec cycle 6 → 3 : 6 images jusqu'à la rencontre. Légende : l'écart croît de 1 par tour ; modulo la longueur du cycle, il atteint 0.
...
## Pièges Python
- `while fast.next` sans `fast and` : `None.next` sur une liste vide ou de longueur impaire.
