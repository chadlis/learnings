...
- Effet marginal ∂p/∂x = β₁·p(1 − p) : à p = 0,5, +100 $ ⇒ +13,7 points ; à p = 0,02, +100 $ ⇒ +1,1 point. Même β, effets différents.
...
6. **L'effet marginal dépend de p.** ∂p/∂x = β₁ p(1 − p) : maximal en p = 0,5 (pente de la sigmoïde β/4), presque nul aux extrêmes. Deux clients, même β, effets de 13,7 et 1,1 points pour +100 $. « Une unité de x change p de β » est faux partout sauf près de 0,5 et pour β petit.
...
5. Effet de +100 $ sur p ? → β·p(1 − p)·100 : 13,7 points à p = 0,5, 1,1 à 0,02.
