...
**Arbitrage de revue 3, 16/09 — validé 16/09.** Le jeu de cinq points chiffrant le pas 8 est **validé** tel quel : il fait son travail, montrer un témoin qui ne peut qu'améliorer le RSS. Chiffres du fil rouge **validés**. Statut `reviewed`.
